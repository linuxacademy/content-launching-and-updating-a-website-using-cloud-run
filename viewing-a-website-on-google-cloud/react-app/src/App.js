      ...
      <div className="App">
        <link rel="stylesheet" href="css/main.css"></link>
          ...
          <header className="w3-display-container w3-content w3-wide" style={{maxWidth: 1500}} id="home">
            <img className="w3-image" src="img/thomas.jpg" alt="Thomas At Your Service" />
          </header>
          ...
          <div className="w3-content w3-padding" style={{maxWidth: 1564}} >
            ...
            <div className="w3-container w3-padding-32" id="about">
              ...
              <p>Thomas At Your Service is one of the <strong>Cat'n Around Catskill 2022</strong> cats, created by Theresa Rowe Obert. </p>
